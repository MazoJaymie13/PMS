...
<!-- <v-row class="ma-0 "  >  -->
    ...
    <v-data-table  dense fixed-header height="500pt" :headers="headers" :items="loadData" show-select v-model="selected" item-key="uname" :single-select="singleselect" class="elevation-1">
    </v-data-table>
